  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center p-12 relative overflow-hidden bg-gradient-to-br from-secondary/50 to-background">
        ...
        <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-accent/20 rounded-full blur-3xl animate-pulse-slow delay-1000" />
        ...
        <div className="relative text-center">
          ...
          <p className="text-muted-foreground max-w-sm">
            Continue monitoring and optimizing your environmental footprint with real-time intelligence.
          </p>
        </div>
      </div>
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="w-full max-w-md">
            <div className="text-center mb-8">
              <h1 className="text-2xl sm:text-3xl font-bold mb-2">Sign in to GreenGrid</h1>
